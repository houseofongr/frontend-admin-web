...
const WaveformWithAudioDarkRow: React.FC<WaveformProps> = ({
  audioUrl,
  audioTitle,
}) => {
  ...
  return (
    <div className="flex lg:flex-row gap-2 flex-col">
      ...
      {/* 컨트롤러 */}
<<<<<<< Updated upstream:src/components/Sound/WaveformWithAudioLightRow.tsx
...
>>>>>>> Stashed changes:src/components/Sound/WaveformWithAudioDarkRow.tsx
      ...
      {/* 파형/오디오 */}
      <div ref={waveformRef} className="flex-1 bg-stone-800/90 rounded-xl" />
    </div>
  );
};
...
export default WaveformWithAudioDarkRow;
